...
const DEVELOPMENT_URL = "/api/auth"; // URL untuk development local (Next.js API Routes)
const HOSTED_URL = "https://api2.mizstudio.my.id/api/auth"; // SLOT: Isi dengan URL server hosting Anda yang baru
